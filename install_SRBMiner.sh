...
wget "https://github.com/$owner/$repo/releases/download/$latest_version/$repo-$version_with_hyphens-Linux.tar.gz" || { echo "Error: Failed to download SRBMiner-Multi archive"; exit 1; }
